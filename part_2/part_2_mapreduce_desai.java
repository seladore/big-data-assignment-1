...
//            String first_let = token.substring(0,1);
//        	letter.set(first_let);
        	if (token.length() > 0){
        		String first_letter = token.substring(0,1).toLowerCase();
        		if (first_letter.matches("[a-zA-Z]")){
        			letter.set(first_letter);
//                System.out.println(first_let);
